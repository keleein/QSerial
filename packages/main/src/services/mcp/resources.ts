...
export const MCP_RESOURCES = [
  {
    uri: 'qserial://connections/active',
    name: 'Active Connections',
    description: 'Current active connections with status',
    mimeType: 'application/json',
  },
  {
    uri: 'qserial://serial/ports',
    name: 'Serial Ports',
    description: 'Available serial ports on this machine',
    mimeType: 'application/json',
  },
  {
    uri: 'qserial://sessions/list',
    name: 'Saved Sessions',
    description: 'All saved connection sessions',
    mimeType: 'application/json',
  },
  {
    uri: 'qserial://screenshot/latest',
    name: 'Latest Screenshot',
    description: 'Latest terminal window screenshot',
    mimeType: 'image/svg+xml',
  },
  {
    uri: 'qserial://notifications/pending',
    name: 'Pending Notifications',
    description: 'Poll pending MCP notifications',
    mimeType: 'application/json',
  },
  {
    uri: 'qserial://connections/{id}',
    name: 'Connection Detail',
    description: 'Detailed info for a specific connection',
    mimeType: 'application/json',
  },
  {
    uri: 'qserial://device/esp32-at',
    name: 'ESP32 AT Commands',
    description: 'ESP32/ESP8266 AT command set reference',
    mimeType: 'text/markdown',
  },
  {
    uri: 'qserial://device/uboot',
    name: 'U-Boot Commands',
    description: 'U-Boot bootloader command reference',
    mimeType: 'text/markdown',
  },
  {
    uri: 'qserial://device/cisco-ios',
    name: 'Cisco IOS Commands',
    description: 'Cisco IOS CLI quick reference',
    mimeType: 'text/markdown',
  },
  {
    uri: 'qserial://device/openwrt',
    name: 'OpenWrt CLI',
    description: 'OpenWrt command-line reference',
    mimeType: 'text/markdown',
  },
];
...
export async function readResource(
  ...
  switch (uri) {
    ...
    case 'qserial://screenshot/latest': {
      return {
        contents: [
          { uri, mimeType: 'text/plain', text: 'Use window_screenshot tool for actual capture.' },
        ],
      };
    }
        ...
        contents: [
          {
            uri,
            mimeType: 'application/json',
            text: JSON.stringify(drainNotifications(), null, 2),
          },
        ],
      };
    }
